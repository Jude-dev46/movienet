    ...
    <div className="mb-8">
      {isLoading ? (
        ...
        <div>
          ...
          <div className="flex flex-col ml-3 mt-3 md:ml-4 md:mt-2 gap-2 overflow-auto hide-scroll transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
            <div className="flex gap-4">
              {filteredData.map((mov) => (
                <div key={mov.id} className="container w-25 flex flex-col">
                  <Image
