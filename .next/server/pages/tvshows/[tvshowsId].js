...
;// CONCATENATED MODULE: ./components/tvshows/SimilarTvshows.jsx
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            filteredData.length === 0 && /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                ...
                                children: "No Similar TvShow Found"
                            }),
                            filteredData.map((tv)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
/* harmony default export */ const tvshows_SimilarTvshows = (SimilarTvshows);

// EXTERNAL MODULE: ./components/UI/skeleton/BtsSkeleton.jsx
var BtsSkeleton = __webpack_require__(2720);
;// CONCATENATED MODULE: ./components/tvshows/TvBts.jsx
...
const TvBTS = ({ data  })=>{
    ...
    const filteredVideos = videos ? videos.filter((vid)=>{
...
/* harmony default export */ const TvBts = (TvBTS);

;// CONCATENATED MODULE: ./components/tvshows/TvCast.jsx
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        filteredData.map((cast)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "container w-21 flex flex-col",
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                                        className: "max-w-none",
...
/* harmony default export */ const tvshows_TvCast = (TvCast);
...
;// CONCATENATED MODULE: ./components/tvshows/TvDetails.jsx
...
const TvDetail = ({ data , cast , watch  })=>{
    const [isLoading, setIsLoading] = (0,external_react_.useState)(true);
    const [tvData, setTvData] = (0,external_react_.useState)(null);
    const [tvCast, setTvCast] = (0,external_react_.useState)([]);
    (0,external_react_.useEffect)(()=>{
        setTimeout(()=>{
            setTvData(data);
            setTvCast(cast);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        tvData.genres ? tvData.genres.map((gen)=>/*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                children: gen.name
                                            }, gen.id)) : ""
                                    ]
                                }),
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        tvData.created_by ? "Not found" : tvData.created_by.map((dir)=>/*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                className: "flex",
                                                children: dir.name
                                            }, dir.id))
                                    ]
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        results.US.flatrate === null ? "Not Found" : results.US.flatrate.map((prov)=>/*#__PURE__*/ jsx_runtime_.jsx("p", {
                ...
                isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(CastSkeleton/* default */.Z, {}) : /*#__PURE__*/ jsx_runtime_.jsx(tvshows_TvCast, {
                    data: tvCast
                })
            ]
        })
...
const TvReviews = ({ data  })=>{
    ...
    const filteredData = reviews ? reviews.filter((author)=>author.author_details.avatar_path !== null) : [];
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(ReviewSkeleton/* default */.Z, {}) : /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "container w-11/12 md:px-4 ml-3 mb-6 md:ml-4 font-mono h-24 shadow-xl overflow-scroll hide-scroll",
                    children: [
                        filteredData.length === 0 && /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                            className: "text-2xl font-sans",
...
/* harmony default export */ const tvshows_TvReviews = (TvReviews);

// EXTERNAL MODULE: ./components/UI/skeleton/TeaserSkeleton.jsx
var TeaserSkeleton = __webpack_require__(6108);
;// CONCATENATED MODULE: ./components/tvshows/TvTeasers.jsx
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(TeaserSkeleton/* default */.Z, {}) : /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "flex flex-row mt-3 ml-4 md:ml-4 md:mt-2 gap-1 overflow-auto hide-scroll",
                    children: [
                        filteredVideos.length === 0 && /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                            className: "text-2xl",
...
/* harmony default export */ const TvTeasers = (TvTeaser);

// EXTERNAL MODULE: ./components/UI/skeleton/TrailerSkeleton.jsx
var TrailerSkeleton = __webpack_require__(1141);
;// CONCATENATED MODULE: ./components/tvshows/TvTrailer.jsx



const TvTrailer = ({ data  })=>{
    const [isLoading, setIsLoading] = (0,external_react_.useState)(true);
    const [vidData, setVidData] = (0,external_react_.useState)(null);
    (0,external_react_.useEffect)(()=>{
        setTimeout(()=>{
        ...
        children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(TrailerSkeleton/* default */.Z, {}) : /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            children: [
                ...
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    children: filteredVideos.map((vid)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "md:ml-4",
                            children: /*#__PURE__*/ jsx_runtime_.jsx("iframe", {
                                className: "w-23 ml-3 md:w-29 md:h-23",
                                src: `https://www.youtube.com/embed/${vid.key}`,
                                frameBorder: "0",
                                allowFullScreen: true
                            })
...
/* harmony default export */ const tvshows_TvTrailer = (TvTrailer);

// EXTERNAL MODULE: ./components/UI/footer/Footer.jsx
var Footer = __webpack_require__(8160);
;// CONCATENATED MODULE: ./pages/tvshows/[tvshowsId]/index.js
...
const TvshowDetails = ({ detail , cast , reviewsDetails , vidDetails , btsDetails , recDetails , watch  })=>{
    if (!detail || !cast || !reviewsDetails || !vidDetails || !btsDetails || !recDetails || !watch) {
        return /*#__PURE__*/ jsx_runtime_.jsx((error_default()), {
            statusCode: 500,
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(TvDetails, {
                        data: detail,
                        cast: cast,
                        watch: watch
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(tvshows_TvReviews, {
                        data: reviewsDetails
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(tvshows_TvTrailer, {
                        data: vidDetails
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(TvTeasers, {
                        data: vidDetails
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(TvBts, {
                        data: btsDetails
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(tvshows_SimilarTvshows, {
                        data: recDetails
                    }),
...
/* harmony default export */ const _tvshowsId_ = (TvshowDetails);
...
async function getStaticProps(context) {
    ...
    try {
        const tvDetails = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US`);
    ...
    https://api.themoviedb.org/3/tv/${tv_id[0]}/credits?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US`);
        ...
        const tvReviews = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}/reviews?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US&page=1`);
        const reviewsDetails = await tvReviews.json();
        const tvVideos = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}/videos?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US`);
        const vidDetails = await tvVideos.json();
        const bts = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}/videos?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US`);
        const btsDetails = await bts.json();
        const tvRecommedations = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}/recommendations?api_key=ccbc07c5fb9e4a890336d35cdf1938e3&language=en-US&page=1`);
        const recDetails = await tvRecommedations.json();
        const watchProvider = await fetch(`https://api.themoviedb.org/3/tv/${tv_id[0]}/watch/providers?api_key=ccbc07c5fb9e4a890336d35cdf1938e3`);
...
var __webpack_exports__ = __webpack_require__.X(0, [443,61,789,74], () => (__webpack_exec__(1758)));
